...
const TagsFilePlugin = makePgSmartTagsFromFilePlugin(
  ...
  path.resolve("./src/server/postgraphile.tags.jsonc"),
);
...
export function getPreset({ authPgPool, rootPgPool }: IPostGraphileOptionsOptions) {
    ...
    extends: [
      ...
      makeV4Preset({
        ...
        */
        ...
        sortExport: true,
        exportGqlSchemaPath: isDev ? "./src/generated/schema.graphql" : undefined,
